...
3. NVidia container toolkit stopped working after updating to Trixie - rerun 'sudo nvidia-ctk runtime configure --runtime=docker'.
4. Also Nvidia container DKMS not working, run this:
